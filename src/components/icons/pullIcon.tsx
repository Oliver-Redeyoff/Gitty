...
const pullIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" x="0px" y="0px">
            <path className="fill arrow" style={{fill: "#000000", stroke: "#000000", strokeWidth: "10px"}} d="M150.59,251.2l89.97,139.55c3.9,6.06,12.76,6.06,16.67,0l90.17-139.87c4.23-6.57-0.44-15.22-8.25-15.28
